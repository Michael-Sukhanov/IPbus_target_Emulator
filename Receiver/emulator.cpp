...
//        th.InfoCode = 0x1;
//        log("ERROR: Bad header of writing transaction");
//    }
//    else{
//        th.InfoCode = 0x0;
//        for(quint8 i = 0 ; i < th.Words; i++){
...
//                log("writing  " + Hex(request[counter + 2 + i]) + " to " + Hex(request[counter + 1] + i));
//            }
//            else{
//                read_only = true;
//                th.InfoCode = 0x5;
//                log("writing  " + Hex(request[counter + 2 + i]) + " to read-only " + Hex(request[counter + 1] + i) + ": forbidden");
//                th.Words = i;
//                break;
//            }
//        }
...
void Emulator::RMWbits_transaction(TransactionHeader th){
    ...
    if(!consistFIFO){
        ...
        log("writing  " + Hex(adress_space[request[counter + 1]]) + " to " + Hex(request[counter + 1]));
