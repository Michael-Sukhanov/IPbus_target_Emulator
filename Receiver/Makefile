...
# Template: app
# Command: E:\Qt\5.14.2\mingw73_32\bin\qmake.exe -o Makefile Reciever.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
#############################################################################
...
ZIP           = zip -r -9
DEF_FILE      = 
RES_FILE      = Reciever_resource_res.o
...
Makefile: Reciever.pro E:/Qt/5.14.2/mingw73_32/mkspecs/win32-g++/qmake.conf E:/Qt/5.14.2/mingw73_32/mkspecs/features/spec_pre.prf \
		...
		res.qrc
	$(QMAKE) -o Makefile Reciever.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
