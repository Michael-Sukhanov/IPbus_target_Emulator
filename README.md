...
Четвертый столбец показывает, является ли значение, записываемое в этот регистр знаковым, или нет, то есть при наличии `1` в этом столбце следует воспринимать величину как число, которое может бытть отрицательным. В противном случае число всегда неотрицательное.
