...
В данном поле реализовно изменение статуса при вводе нового значения в биты SEND READOUT COMMAND. Статус полностью соответствует записанному занчению, причем регистры управления зануляются.
