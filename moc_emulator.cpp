...
QT_MOC_LITERAL(3, 23, 11) // "FIFOchanged"
    ...
    "Emulator\0ValueChanged\0\0FIFOchanged"
};
...
void Emulator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Emulator::ValueChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Emulator::*)(quint16 );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Emulator::FIFOchanged)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Emulator::ValueChanged(quint16 _t1)
{
...
// SIGNAL 1
void Emulator::FIFOchanged(quint16 _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
